...
const listDepositions = ref<IDepositions[]>([
  ...
  {
    depositions: '"Comforty é simplesmente perfeita! Suas cadeiras são a união ideal entre conforto e elegância. A equipe é atenciosa e conhecedora, oferecendo uma variedade incrível de designs ergonômicos e duráveis. Recomendo Bastante!"',
    image: persona2,
    name: 'Esther Howard',
    job: 'Fashion Designer'
  }
    ...
    <div class="w-[85%] mx-auto py-4 lg:w-[57%]">
      ...
      <div class="md:flex md:justify-between gap-4">
        <div 
          ...
          v-for="list in listDepositions" :key="list.name"
        >
          <div class="flex items-center">
            <div class="col-color"></div>

            <p class="text-[18px] text-gray-dark font-normal p-4 pr-4">
              {{ list.depositions }}
            </p>
          </div>
          ...
          <div class="flex justify-between">
            <div class="flex items-center gap-2">
              <img :src="list.image" alt="imagem do rosto de cliente que escreveu o depoimento." />
