...
const chairList = [
  {
    ...
    subTitle: 'Melhores móveis, Coleção para seu interior.',
    path: banner1,
    name: 'cadeira retro',
  },
  {
    title: 'Seu conforto.',
    subTitle: 'Nossa prioridade é deixar seu lar confortavel.',
    path: banner2,
    name: 'poltrona retro1',
  },
  {
    title: 'Design  rústico.',
    subTitle: 'Além de cadeiras modernas, temos versão rústica.',
    path: banner3,
    name: 'poltrona retro2',
  },
];
...
<template>
  ...
  >
      ...
      <div class="pl-4 flex md:gap-10 md:mt-8">
        <div class="md:w-[370px]">
          <div class="my-8 text-center md:text-left">
            ...
            <h3
              class="text-xl font-bold tracking-tight leading-10 md:text-xl lg:text-2xl"
            >
    ...
    <div class="hidden md:flex md:justify-center md:gap-2">
      <canvas
        :class="[
          'bg-gray-dark w-[8px] h-[8px] rounded-full',
          { 'bg-primary': image === 0 },
        ]"
      />
      <canvas
